...
solver = caffe.RMSPropSolver('solver_deploy.prototxt')
solver.net.copy_from('snapshot/mobilenet_iter_1979.caffemodel')
...
labelmap_file = 'labelmap.prototxt'
...
feat = net.blobs['conv15_2'].data[0, :]
